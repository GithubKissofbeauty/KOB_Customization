report 50384 "KOB_Return Consign Confirm"
{
    ...
    dataset
    {
        dataitem("Sales Header"; "UBC_Consignment Header")
        {
            DataItemTableView = SORTING("UBC_Document Type", "UBC_No.") WHERE("UBC_Document Type" = CONST("Return Consignment Order"));
            RequestFilterFields = "UBC_No.", "UBC_Sell-to Customer No.";
            RequestFilterHeading = 'Return Consign Order Confirmation';
            column(DocType_SalesHdr; "UBC_Document Type")
            {
            }
            column(No_SalesHdr; "UBC_No.")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BilltoCustNo_SalesHdr; "Sales Header"."UBC_Bill-to Customer No.")
                    {
                    }
                    column(DocDate_SalesHdr; Format("Sales Header"."UBC_Document Date", 0, 4))
                    {
                    }
                    column(VATNoText; VATNoText)
                    {
                    }
                    column(VATRegNo_SalesHdr; "Sales Header"."UBC_VAT Registration No.")
                    {
                    }
                    ...
                    column(YourReference_SalesHdr; "Sales Header"."UBC_Your Reference")
                    {
                    }
                    ...
                    column(PricesInclVAT_SalesHdr; "Sales Header"."UBC_Prices Including VAT")
                    {
                    }
                    ...
                    column(PricesInclVATYesNo_SalesHdr; Format("Sales Header"."UBC_Prices Including VAT"))
                    {
                    }
                    column(SelltoCustNo_SalesHdr; "Sales Header"."UBC_Sell-to Customer No.")
                    {
                    }
                    ...
                    column(BilltoCustNo_SalesHdrCaption; "Sales Header".FieldCaption("UBC_Bill-to Customer No."))
                    {
                    }
                    column(PricesInclVAT_SalesHdrCaption; "Sales Header".FieldCaption("UBC_Prices Including VAT"))
                    {
                    }
                    column(SelltoCustNo_SalesHdrCaption; "Sales Header".FieldCaption("UBC_Sell-to Customer No."))
                    {
                    }
                    ...
                    dataitem("Sales Line"; "UBC_Consignment Line")
                    {
                        DataItemLink = "UBC_Document Type" = FIELD("UBC_Document Type"), "UBC_Document No." = FIELD("UBC_No.");
                        DataItemLinkReference = "Sales Header";
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Desc_SalesLine; "Sales Line".UBC_Description)
                        {
                        }
                        column(DocNo_SalesLine; TempSalesLine."Document No.")
                        {
                        }
                        column(No2_SalesLine; "Sales Line"."UBC_No.")
                        {
                        }
                        column(Qty_SalesLine; "Sales Line".UBC_Quantity)
                        {
                        }
                        column(UOM_SalesLine; "Sales Line"."UBC_Unit of Measure")
                        {
                        }
                        column(UnitPrice_SalesLine; "Sales Line"."UBC_Unit Price")
                        {
                        }
                        column(LineDisc_SalesLine; "Sales Line"."UBC_Line Discount %")
                        {
                        }
                        column(AllowInvDisc_SalesLine; "Sales Line"."UBC_Allow Invoice Disc.")
                        {
                            IncludeCaption = false;
                        }
                        column(VATIdentifier_SalesLine; "Sales Line"."UBC_VAT Identifier")
                        {
                        }
                        column(AllowInvDiscYesNo_SalesLine; Format("Sales Line"."UBC_Allow Invoice Disc."))
                        {
                        }
                        column(SalesLineInvDiscAmt; -TempSalesLine."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."UBC_Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATBaseDiscount_SalesHdr; "Sales Header"."UBC_VAT Base Discount %")
                        {
                        }
                        ...
                        column(Desc_SalesLineCaption; "Sales Line".FieldCaption(UBC_Description))
                        {
                        }
                        column(No2_SalesLineCaption; "Sales Line".FieldCaption("UBC_No."))
                        {
                        }
                        column(Qty_SalesLineCaption; "Sales Line".FieldCaption(UBC_Quantity))
                        {
                        }
                        column(UOM_SalesLineCaption; "Sales Line".FieldCaption("UBC_Unit of Measure"))
                        {
                        }
                        column(VATIdentifier_SalesLineCaption; "Sales Line".FieldCaption("UBC_VAT Identifier"))
                        {
                        }
                        dataitem(DimensionLoop2; "Integer")
                        {
                            ...
                            begin
                                ...
                                DimSetEntry2.SetRange("Dimension Set ID", "Sales Line"."UBC_Dimension Set ID");
                            end;
                        }
                    ...
                    dataitem(VATCounterLCY; "Integer")
                    {
                        ...
                        begin
                            ...
                            VALVATBaseLCY := Round(CurrExchRate.ExchangeAmtFCYToLCY(
                                  "Sales Header"."UBC_Posting Date", "Sales Header"."UBC_Currency Code",
                                  TempVATAmountLine."VAT Base", "Sales Header"."UBC_Currency Factor"));
                            VALVATAmountLCY := Round(CurrExchRate.ExchangeAmtFCYToLCY(
                                  "Sales Header"."UBC_Posting Date", "Sales Header"."UBC_Currency Code",
                                  TempVATAmountLine."VAT Amount", "Sales Header"."UBC_Currency Factor"));
                        end;

                        trigger OnPreDataItem()
                        begin
                            if (not GLSetup."Print VAT specification in LCY") or
                               ("Sales Header"."UBC_Currency Code" = '') or
                            ...
                            CurrExchRate.FindCurrency("Sales Header"."UBC_Posting Date", "Sales Header"."UBC_Currency Code", 1);
                ...
                begin
                    ...
                    VATDiscountAmount :=
                      TempVATAmountLine.GetTotalVATDiscount("Sales Header"."UBC_Currency Code", "Sales Header"."UBC_Prices Including VAT");
